...
namespace ItemService.Domain.Seed
{
    public static class DbSeeder
    {
        public static void Seed(this ModelBuilder builder)
        {
            ...
            builder.SeedItems();
            builder.SeedItemAllergens();
            builder.SeedItemIngredients();
        }
        ...
        private static void SeedItemIngredients(this ModelBuilder builder)
        {
            var entities = new List<ItemIngredient>()
            {
                new ItemIngredient()
                {
            ...
            builder.Entity<ItemIngredient>().HasData(entities);
        }
        private static void SeedItemAllergens(this ModelBuilder builder)
        {
            var entities = new List<ItemAllergen>()
            {
                new ItemAllergen()
                {
                    ItemId = new Guid("dbd5bd9c-f317-4b16-8e37-8b18bf07d614"),
            ...
            builder.Entity<ItemAllergen>().HasData(entities);
        }
